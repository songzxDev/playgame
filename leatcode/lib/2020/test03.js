...
const buildTree = function (preorder, inorder) {
    ...
    const buildHelper = (preLeft, preRight, inLeft, inRight) => {
        ...
        curRoot.left = buildHelper(preLeft + 1, leftSubtreeLen + preLeft, inLeft, inRootIdx - 1);
        curRoot.right = buildHelper(leftSubtreeLen + preLeft + 1, preRight, inRootIdx + 1, inRight);
        return curRoot;
    };
